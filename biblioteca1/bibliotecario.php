...
<?php
  ...
  $res=mysqli_query($con,"select * from bibliotecario");

  echo "<table border=1>";
  echo "<tr><th>ci</th><th>nombres</th><th>apellidos</th><th>correo</th><th>telefono</th><th>password</th><th>descripcion</th></tr>";
